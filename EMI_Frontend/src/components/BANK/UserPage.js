...
export default function AdminPage()
{
    return(
      ...
      <div class="hero-left-side">
        <h1>Hey, Banks Hello How should we help you ?</h1>
        <p>
        👉Banks provide a sense of financial stability by safeguarding deposits and offering various financial services that help individuals and businesses manage their money effectively.👈
        </p>
    ...
    <Card style={{height:'530px', textAlign:'center'}}>
        <Card.Img variant="top" src={Image6}  style={{height:'380px',width:'750px', textAlign:'center',marginLeft:'22rem', marginTop:'20px'}}/>
        <Card.Body>
          <Card.Text style={{width:'750px', textAlign:'center',marginLeft:'22rem' }}>
          👉Customers can give Feedback whether they like service or not while servicing at the our agency . We respect the feedback you provide. We value your time and ensure fast delivery of your service.👈
          </Card.Text>
        </Card.Body>
      </Card>
      <br />
