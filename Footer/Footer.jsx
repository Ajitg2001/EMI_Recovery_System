      ...
      <div className="container copyright">
        <div className="row">
          <div className="col-md-6">
            <p>&copy; <a href="https://freewebsitecode.com" style={{textDecoration:'none'}}>emirecover961@gmail.com</a>, All Right Reserved.</p>
          </div>
          {/* <div className="col-md-6">
  ...
  return (
    <div className="col-md-6 col-lg-3">
      <div className="footer-contact">
        ...
        <p><i className="fa fa-map-marker-alt"></i>Money Magnet Office, New Delhi</p>
